const quotes = [
    {
        quote: "하늘을 날고싶은 충동을 느낄 때, 결코 땅을 기라는데 동의할 수는 없다.",
        author: "헬렌 켈러",
    },
    {
    ...
    {
        quote: "조금도 위험을 감수하지 않는 것이 인생에서 가장 위험한 일일 것이라 믿어요.",
        author: "오프라 윈프리",
    },
    {
    ...
    {
        quote: "언제까지고 계속되는 불행은 없다. 가만히 견디고 참든지 용기로 내쫓아 버리든지 둘 중에 하나를 택해야한다.",
        author: "로망 롤랑",
    },
    {
        quote: "아무것도 손 쓸 방법이 없을 때 꼭 한 가지 방법이 있다. 그 것은 용기를 갖는 것이다.",
        author: "유태 격언",
    },
    {
        quote: "세상을 보고 무수한 장애물을 넘어 벽을 허물고 더 가까이 다가가 서로를 알아가고 느끼는 것, 그 것이 바로 인생의 목표이다.",
    ...
    {
        quote: "남들이 당신을 어떻게 생각할까 너무 걱정하지말라. 그들은 그렇게 당신에게 관심이 있지않다.",
        author: "",
    },
    {
    ...
    {
        quote: "나는 신발이 없다고 울적해했네, 거리에서 발이 없는 사람을 만나기 전까지",
        author: "데일 카네기",
    },
    {
    ...
    {
        quote: "하루하루를 자기 인생의 마지막 날같이 살아라. 언젠가는 그 날들 가운데 진짜 마지막 날이 있을테니",
        author: "레오 부스칼리아",
    },
    {
        quote: "나이를 먹은 것만으로는 늙지 않는다. 이상을 잃었을 때 비로소 노화되는 것이다.",
        author: "사무엘 올만",
    },
    {
        quote: "우리 모두 현실주의자가 되자. 그러나 가슴 속에는 불가능한 꿈을 품자.",
        author: "체 게바라",
    },
    {
